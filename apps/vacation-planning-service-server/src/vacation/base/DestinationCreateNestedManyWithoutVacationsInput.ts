...
@InputType()
class DestinationCreateNestedManyWithoutVacationsInput {
...
export { DestinationCreateNestedManyWithoutVacationsInput as DestinationCreateNestedManyWithoutVacationsInput };
